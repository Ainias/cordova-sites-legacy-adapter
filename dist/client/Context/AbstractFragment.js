 ...
 */
var AbstractFragment = /** @class */ (function (_super) {
    __extends(AbstractFragment, _super);
    /**
     ...
     * @returns
     */
    AbstractFragment.prototype.getSite = function () {
        if (this._site instanceof AbstractFragment) {
            return this._site.getSite();
        }
        return this._site;
    };
    AbstractFragment.prototype.startSite = function (site, args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getSite().startSite(site, args)];
            });
        });
    };
    /**
     ...
     * @returns {boolean}
     */
    AbstractFragment.prototype.isActive = function () {
        return this._active;
    };
    AbstractFragment.prototype.setViewQuery = function (query) {
        this._viewQuery = query;
    };
    AbstractFragment.prototype.getViewQuery = function () {
        return this._viewQuery;
    };
    AbstractFragment.prototype.setActive = function (active) {
        this._active = active;
